...
/**
 * Compute the number of steps required to reach 1 for a given integer by
 * applying the algorithm of the Collatz conjecture.
 *
 * @param n – The input integer.
 * @param stoppingTime – The current number of steps. Used for recursvie calls.
