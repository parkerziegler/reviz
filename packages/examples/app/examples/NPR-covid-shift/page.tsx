...
export const metadata: Metadata = {
  title:
    "reviz: NPR — America's 200,000 COVID-19 Deaths: Small Cities And Towns Bear A Growing Share",
  description:
    'The reviz compiler can reverse engineer stacked bar charts from the DOM, such as this example from NPR.',
};

const NPRCovidShift: React.FC = () => {
  return (
    <Visualization
      title="From NPR — America's 200,000 COVID-19 Deaths: Small Cities And Towns Bear A Growing Share"
      ...
      >
        <g transform="translate(37, 0)">
          ...
          >
            ...
            ></path>
            <g className="npr-tick" opacity="1" transform="translate(0,336.5)">
              <line stroke="currentColor" x2="-6"></line>
              <text fill="currentColor" x="-9" dy="0.32em">
                0%
              </text>
            </g>
            <g className="npr-tick" opacity="1" transform="translate(0,275.5)">
              <line stroke="currentColor" x2="-6"></line>
              <text fill="currentColor" x="-9" dy="0.32em">
                20%
              </text>
            </g>
            <g className="npr-tick" opacity="1" transform="translate(0,214.5)">
              <line stroke="currentColor" x2="-6"></line>
              <text fill="currentColor" x="-9" dy="0.32em">
                40%
              </text>
            </g>
            <g className="npr-tick" opacity="1" transform="translate(0,153.5)">
              <line stroke="currentColor" x2="-6"></line>
              <text fill="currentColor" x="-9" dy="0.32em">
                60%
              </text>
            </g>
            <g className="npr-tick" opacity="1" transform="translate(0,92.5)">
              <line stroke="currentColor" x2="-6"></line>
              <text fill="currentColor" x="-9" dy="0.32em">
                80%
              </text>
            </g>
            <g className="npr-tick" opacity="1" transform="translate(0,31.5)">
              <line stroke="currentColor" x2="-6"></line>
              <text fill="currentColor" x="-9" dy="0.32em">
                100%
              </text>
